...
class Power_Bi_Post_Types
{
	...
	{
		$labels = array(
			'name' => _x('Power BI Items', 'Post type general name', 'embed-power-bi'),
			'singular_name' => _x('Power BI', 'Post type singular name', 'embed-power-bi'),
			'menu_name' => _x('Power BI', 'Admin Menu text', 'embed-power-bi'),
			'name_admin_bar' => _x('Power BI', 'Add New on Toolbar', 'embed-power-bi'),
			'add_new' => __('Add New', 'embed-power-bi'),
			'add_new_item' => __('Add New Power BI', 'embed-power-bi'),
			'new_item' => __('New Power BI', 'embed-power-bi'),
			'edit_item' => __('Edit Power BI', 'embed-power-bi'),
			'view_item' => __('View Power BI', 'embed-power-bi'),
			'all_items' => __('All Power BI Items', 'embed-power-bi'),
			'search_items' => __('Search Power BI Items', 'embed-power-bi'),
			'parent_item_colon' => __('Parent Power BI Items:', 'embed-power-bi'),
			'not_found' => __('No Power BI found.', 'embed-power-bi'),
			'not_found_in_trash' => __('No Power BI found in Trash.', 'embed-power-bi'),
			'featured_image' => _x('Power BI Cover Image', 'Overrides the “Featured Image” phrase for this post type. Added in 4.3', 'embed-power-bi'),
			'set_featured_image' => _x('Set cover image', 'Overrides the “Set featured image” phrase for this post type. Added in 4.3', 'embed-power-bi'),
			'remove_featured_image' => _x('Remove cover image', 'Overrides the “Remove featured image” phrase for this post type. Added in 4.3', 'embed-power-bi'),
			'use_featured_image' => _x('Use as cover image', 'Overrides the “Use as featured image” phrase for this post type. Added in 4.3', 'embed-power-bi'),
			'archives' => _x('Power BI archives', 'The post type archive label used in nav menus. Default “Post Archives”. Added in 4.4', 'embed-power-bi'),
			'insert_into_item' => _x('Insert into report', 'Overrides the “Insert into post”/”Insert into page” phrase (used when inserting media into a post). Added in 4.4', 'embed-power-bi'),
			'uploaded_to_this_item' => _x('Uploaded to this report', 'Overrides the “Uploaded to this post”/”Uploaded to this page” phrase (used when viewing media attached to a post). Added in 4.4', 'embed-power-bi'),
			'filter_items_list' => _x('Filter reports list', 'Screen reader text for the filter links heading on the post type listing screen. Default “Filter posts list”/”Filter pages list”. Added in 4.4', 'embed-power-bi'),
			'items_list_navigation' => _x('Power BI Items list navigation', 'Screen reader text for the pagination heading on the post type listing screen. Default “Posts list navigation”/”Pages list navigation”. Added in 4.4', 'embed-power-bi'),
			'items_list' => _x('Power BI Items list', 'Screen reader text for the items list heading on the post type listing screen. Default “Posts list”/”Pages list”. Added in 4.4', 'embed-power-bi'),
		);
		$args = array(
			'labels' => $labels,
			'public' => true,
	...
	public function power_bi_metaboxs()
	{
		...
		$metabox_details->add_field(
			array(
				...
				'default' => 'report',
				'options' => array(
					'report' => __('Report', 'embed-power-bi'),
					'visual' => __('Report Visual', 'embed-power-bi'),
					'qna' => __('Q&A', 'embed-power-bi'),
					'dashboard' => __('Dashboard', 'embed-power-bi'),
					'tile' => __('Tile', 'embed-power-bi'),
				),
			));
		$metabox_details->add_field(
			array(
				...
				'default' => 'view',
				'options' => array(
					'view' => __('View Mode', 'embed-power-bi'),
					'edit' => __('Edit Mode', 'embed-power-bi'),
					'create' => __('Create Mode', 'embed-power-bi'),
				),
				'attributes' => array(
		...
		$metabox_details->add_field(
			array(
				...
				'default' => 'show_qna',
				'options' => array(
					'show_qna' => __('Show Q&A', 'embed-power-bi'),
					'show_qna_predefined' => __('Show Q&A with predefined question', 'embed-power-bi'),
					'show_a_predefined' => __('Show answer only with predefined question', 'embed-power-bi'),
				),
				'attributes' => array(
					'data-conditional-id' => $prefix . 'embed_type',
	...
	{
		$columns['type'] = __('Type', 'embed-power-bi');
		$columns['shortcode'] = __('Shortcode', 'embed-power-bi');
		return $columns;
	}
		...
		switch ($column) {
			case 'type':
				...
				if (!empty($type)) {
					...
					esc_html_e('Unable to get type', 'embed-power-bi');
				}
				break;
			case 'shortcode':
