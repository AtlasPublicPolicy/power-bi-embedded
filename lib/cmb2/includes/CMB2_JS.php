...
class CMB2_JS {
	...
	protected static function colorpicker_frontend() {
		...
		wp_localize_script( 'wp-color-picker', 'wpColorPickerL10n', array(
			'clear'         => esc_html__( 'Clear', 'embed-power-bi' ),
			'defaultString' => esc_html__( 'Default', 'embed-power-bi' ),
			'pick'          => esc_html__( 'Select Color', 'embed-power-bi' ),
			'current'       => esc_html__( 'Current Color', 'embed-power-bi' ),
		) );
	}
		...
		$l10n = array(
			...
			'defaults'          => array(
				...
				'date_picker'  => array(
					'changeMonth'     => true,
					'changeYear'      => true,
					'dateFormat'      => _x( 'mm/dd/yy', 'Valid formatDate string for jquery-ui datepicker', 'embed-power-bi' ),
					'dayNames'        => explode( ',', esc_html__( 'Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday', 'embed-power-bi' ) ),
					'dayNamesMin'     => explode( ',', esc_html__( 'Su, Mo, Tu, We, Th, Fr, Sa', 'embed-power-bi' ) ),
					'dayNamesShort'   => explode( ',', esc_html__( 'Sun, Mon, Tue, Wed, Thu, Fri, Sat', 'embed-power-bi' ) ),
					'monthNames'      => explode( ',', esc_html__( 'January, February, March, April, May, June, July, August, September, October, November, December', 'embed-power-bi' ) ),
					'monthNamesShort' => explode( ',', esc_html__( 'Jan, Feb, Mar, Apr, May, Jun, Jul, Aug, Sep, Oct, Nov, Dec', 'embed-power-bi' ) ),
					'nextText'        => esc_html__( 'Next', 'embed-power-bi' ),
					'prevText'        => esc_html__( 'Prev', 'embed-power-bi' ),
					'currentText'     => esc_html__( 'Today', 'embed-power-bi' ),
					'closeText'       => esc_html__( 'Done', 'embed-power-bi' ),
					'clearText'       => esc_html__( 'Clear', 'embed-power-bi' ),
				),
				'time_picker'  => array(
					'timeOnlyTitle' => esc_html__( 'Choose Time', 'embed-power-bi' ),
					'timeText'      => esc_html__( 'Time', 'embed-power-bi' ),
					'hourText'      => esc_html__( 'Hour', 'embed-power-bi' ),
					'minuteText'    => esc_html__( 'Minute', 'embed-power-bi' ),
					'secondText'    => esc_html__( 'Second', 'embed-power-bi' ),
					'currentText'   => esc_html__( 'Now', 'embed-power-bi' ),
					'closeText'     => esc_html__( 'Done', 'embed-power-bi' ),
					'timeFormat'    => _x( 'hh:mm TT', 'Valid formatting string, as per http://trentrichardson.com/examples/timepicker/', 'embed-power-bi' ),
					'controlType'   => 'select',
					'stepMinute'    => 5,
				),
			),
			'strings' => array(
				'upload_file'  => esc_html__( 'Use this file', 'embed-power-bi' ),
				'upload_files' => esc_html__( 'Use these files', 'embed-power-bi' ),
				'remove_image' => esc_html__( 'Remove Image', 'embed-power-bi' ),
				'remove_file'  => esc_html__( 'Remove', 'embed-power-bi' ),
				'file'         => esc_html__( 'File:', 'embed-power-bi' ),
				'download'     => esc_html__( 'Download', 'embed-power-bi' ),
				'check_toggle' => esc_html__( 'Select / Deselect All', 'embed-power-bi' ),
			),
		);
